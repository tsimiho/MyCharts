...
function MainPage({user, setUser}) {
  ...
  useEffect(() => {
    ...
    google.accounts.id.initialize({
      client_id: "919864012907-eihr65v77jminklnqd7j61r2bf6q2pdt.apps.googleusercontent.com",
    ...
    <div className='background'>
      ...
      <div className="buttonscontainer"> 
        ...
        datasets: [
          ...
          <button className='mainbutton' onClick={closeModal}>Back</button>
        </Modal>
      </div>
      <div className='container'>
        <h2 className='title'> Press on a diagram to see how it works, or login with your google account to start creating your diagrams</h2>
